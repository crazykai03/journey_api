    ...
    if ((my_minutes % jour_interval==0 and my_second == 0) or first_time_start_up==True ):
        ...
        try:
           ...
           # names = [H2_CH_str, K02_CH_str, K04_CH_str, H2_EH_str, K02_EH_str, H2_WH_str, K04_WH_str]
            update_data = [data[H2_WH].get("JOURNEY_DATA")+ "." + data[H2_WH].get("COLOUR_ID"), data[H2_EH].get("JOURNEY_DATA")+ "." + data[H2_EH].get("COLOUR_ID"), data[H2_CH].get("JOURNEY_DATA")+ "." + data[H2_CH].get("COLOUR_ID"),
